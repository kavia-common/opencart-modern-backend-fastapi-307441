...
@router.get(
    ...
    description="Admin endpoint to list all orders in the system with pagination.",
    operation_id="adminListAllOrders",
)
def list_all_orders(
...
@router.put(
    ...
    description="Admin endpoint to update an order's status by order_id.",
